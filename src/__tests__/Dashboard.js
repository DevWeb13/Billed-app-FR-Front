...
import { billsFixtures } from "../fixtures/bills"
...
describe('Given I am connected as an Admin', () => {
  describe('When I am on Dashboard page, there are bills, and there is one pending', () => {
    test('Then, filteredBills by pending status should return 1 bill', () => {
      const filtered_bills = filteredBills(billsFixtures, "pending")
  ...
  describe('When I am on Dashboard page, there are bills, and there is one accepted', () => {
    test('Then, filteredBills by accepted status should return 1 bill', () => {
      const filtered_bills = filteredBills(billsFixtures, "accepted")
      expect(filtered_bills.length).toBe(1)
    })
  })
  describe('When I am on Dashboard page, there are bills, and there is two refused', () => {
    test('Then, filteredBills by accepted status should return 2 bills', () => {
      const filtered_bills = filteredBills(billsFixtures, "refused")
  ...
  describe('When I am on Dashboard page and I click on arrow', () => {
    test('Then, tickets list should be unfolding, and cards should appear', async () => {
      ...
      const dashboard = new Dashboard({
        document, onNavigate, store: null, bills:billsFixtures, localStorage: window.localStorage
      })
      document.body.innerHTML = DashboardUI({ data: { billsFixtures } })

      const handleShowTickets1 = jest.fn((e) => dashboard.handleShowTickets(e, billsFixtures, 1))
      const handleShowTickets2 = jest.fn((e) => dashboard.handleShowTickets(e, billsFixtures, 2))
      const handleShowTickets3 = jest.fn((e) => dashboard.handleShowTickets(e, billsFixtures, 3))
...
describe('Given I am connected as Admin, and I am on Dashboard page, and I clicked on a pending bill', () => {
  describe('When I click on accept button', () => {
    test('I should be sent on Dashboard with big billed icon instead of form', () => {
      ...
      document.body.innerHTML = DashboardFormUI(billsFixtures[0])
      ...
      const handleAcceptSubmit = jest.fn((e) => dashboard.handleAcceptSubmit(e, billsFixtures[0]))
  ...
  describe('When I click on refuse button', () => {
    test('I should be sent on Dashboard with big billed icon instead of form', () => {
      ...
      const handleRefuseSubmit = jest.fn((e) => dashboard.handleRefuseSubmit(e, billsFixtures[0]))
